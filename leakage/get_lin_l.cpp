...
void quad_l_x(int index_x, int index_y, int M, int G, int nxf, int nyf, vector<double> &mi, vector<double> &n,
			...
			vector<vector<vector<double>>> &b0, vector<vector<vector<double>>> &b1,
	...
	vector<double> arr (MG), lx (MG), lxl (MG), lxo (MG);
		...
		if(index_y == 0){ ///////////////////////////////// NOROESTE
		    ...
		    for(int g = 0 ; g < G ; g++){
				for(int k = lb ; k < ub ; k++){
					...
					p1 = (psi_x[index_y][index_x][aux] + psi_y[index_y][index_x][aux])/2;
					p2 = (psi_x[index_y][index_x][aux] + psi_x[index_y + 1][index_x][aux] + psi_y[index_y + 1][index_x][aux])/3;

					p2 = (nhy[index_y][index_x][k]) * (p1 - p2);
		...
		if(index_y == 0){ ///////////////////////////////// NORDESTE
		    ...
		    for(int g = 0 ; g < G ; g++){
				for(int k = lb ; k < ub ; k++){
					...
					p1 = (psi_x[index_y][index_x + 1][aux] + psi_y[index_y][index_x][aux])/2;
					p2 = (psi_x[index_y][index_x + 1][aux] + psi_x[index_y + 1][index_x + 1][aux] + psi_y[index_y + 1][index_x][aux])/3;
	...
	b1[index_y][index_x] = mult(A_p_inv_z[zcn[index_y][index_x]], c1[index_y][index_x]);
...
void quad_l_y(int index_x, int index_y, int M, int G, int nxf, int nyf, vector<double> &mi, vector<double> &n,
	...
	vector<double> arr (MG), ly (MG), lys (MG), lyn (MG);
