...
void sweep_4(const int &M, 
	...
	int MG = M*G, index;
		...
		for(int i = 0 ; i < nyf ; i++){
			...
			quad_l_x(j, i, M, G, nxf, nyf, mi, n, zcn, A_p_inv_z, l_y, q, h_x, h_y, c1_x, c2_x, b0_x, b1_x, b2_x, psi_x, psi_y, mhx, nhy, M/2, 3*M/4);
			quad_l_y(j, i, M, G, nxf, nyf, mi, n, zcn, A_p_inv_z, l_x, q, h_x, h_y, c1_y, c2_y, b0_y, b1_y, b2_y, psi_x, psi_y, mhx, nhy, M/2, 3*M/4);
