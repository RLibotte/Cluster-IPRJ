				...
				for(int k = 0 ; k < M/4 ; k++){
					for(int l = 0 ; l < MG ; l++){
						if(D_x[zcn[i][j]][l] > 0){
							...
							psi_in_x_inv[i][j][k + M*g][l] = V_x[zcn[i][j]][k + M*g][l] * exp(h_x[i][j]/D_x[zcn[i][j]][l]);
							psi_in_x_inv[i][j][k + M*g + 3*M/4][l] = V_x[zcn[i][j]][k + M*g + 3*M/4][l] * exp(h_x[i][j]/D_x[zcn[i][j]][l]);

							psi_in_x_inv[i][j][k + M*g + M/4][l] = V_x[zcn[i][j]][k + M*g + M/4][l];
							psi_in_x_inv[i][j][k + M*g + M/2][l] = V_x[zcn[i][j]][k + M*g + M/2][l];
						}
					}
					...
					for(int l = 0 ; l < MG ; l++){
						if(D_y[zcn[i][j]][l] > 0){
							...
							psi_in_y_inv[i][j][k + M*g][l] = V_y[zcn[i][j]][k + M*g][l] * exp(h_y[i][j]/D_y[zcn[i][j]][l]);
							psi_in_y_inv[i][j][k + M*g + M/4][l] = V_y[zcn[i][j]][k + M*g + M/4][l] * exp(h_y[i][j]/D_y[zcn[i][j]][l]);
							
							psi_in_y_inv[i][j][k + M*g + M/2][l] = V_y[zcn[i][j]][k + M*g + M/2][l];
							psi_in_y_inv[i][j][k + M*g + 3*M/4][l] = V_y[zcn[i][j]][k + M*g + 3*M/4][l];
						}
					}
				}
			}
				...
				for(int k = 0 ; k < M/4 ; k++){
					for(int l = 0 ; l < MG ; l++){
						if(D_x[zcn[i][j]][l] > 0){
							...
							psi_in_x[i][j][k + g*M][l] = V_x[zcn[i][j]][k + g*M][l];
							psi_in_x[i][j][k + g*M + 3*M/4][l] = V_x[zcn[i][j]][k + g*M + 3*M/4][l];

							psi_in_x[i][j][k + g*M + M/4][l] = V_x[zcn[i][j]][k + g*M + M/4][l] * exp(h_x[i][j]/D_x[zcn[i][j]][l]);
							psi_in_x[i][j][k + g*M + M/2][l] = V_x[zcn[i][j]][k + g*M + M/2][l] * exp(h_x[i][j]/D_x[zcn[i][j]][l]);
						}
					}
					...
					for(int l = 0 ; l < MG ; l++){
						if(D_y[zcn[i][j]][l] > 0){
							...
							psi_in_y[i][j][k + g*M][l] = V_y[zcn[i][j]][k + g*M][l];
							psi_in_y[i][j][k + g*M + M/4][l] = V_y[zcn[i][j]][k + g*M + M/4][l];
							
							psi_in_y[i][j][k + g*M + M/2][l] = V_y[zcn[i][j]][k + g*M + M/2][l] * exp(h_y[i][j]/D_y[zcn[i][j]][l]);
							psi_in_y[i][j][k + g*M + 3*M/4][l] = V_y[zcn[i][j]][k + g*M + 3*M/4][l] * exp(h_y[i][j]/D_y[zcn[i][j]][l]);
						}
					}
				}
			}
