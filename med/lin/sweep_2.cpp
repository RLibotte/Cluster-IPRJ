...
void sweep_2(const int &M, 
	...
	int MG = M*G, index;
		...
		for(int i = nyf - 1 ; i >= 0 ; i--){
			...
			quad_l_x(j, i, M, G, nxf, nyf, mi, n, zcn, A_p_inv_z, l_y, q, h_x, h_y, c1_x, b0_x, b1_x, psi_x, psi_y, 0, M/4, mhx, nhy);
			quad_l_y(j, i, M, G, nxf, nyf, mi, n, zcn, A_p_inv_z, l_x, q, h_x, h_y, c1_y, b0_y, b1_y, psi_x, psi_y, 0, M/4, mhx, nhy);
