...
tuple<vector<double>,
	...
	return {b_in_x, b_in_y, psi_x_p, psi_y_p, l_x_temp, l_y_temp, psi_x_out, psi_y_out,
			psi_x, psi_y, psi_b_x, psi_b_y, alpha_x, alpha_y, l_x, l_y, scalar_flux_x, scalar_flux_x_out, 
			scalar_flux_y, scalar_flux_y_out, psi_x_p_out,
			psi_y_p_out, psi_x_old, psi_y_old, 
			c1_x, b0_x, b1_x, c1_y, b0_y, b1_y, b_aux_x, b_aux_y, mhx, nhy,
			A_p_lu, psi_in_x, psi_in_y, psi_in_x_inv, psi_in_y_inv};
}